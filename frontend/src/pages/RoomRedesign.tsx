...
const STYLE_OPTIONS = [
  { value: 'neo-classical',        labelEn: 'Neo-Classical',         labelAr: 'نيو كلاسيك' },
  { value: 'classical',            labelEn: 'Classical',             labelAr: 'كلاسيكي' },
  { value: 'victorian',            labelEn: 'Victorian',             labelAr: 'فيكتوري' },
  { value: 'japandi',              labelEn: 'Japandi',               labelAr: 'ياباندي' },
  { value: 'scandinavian',         labelEn: 'Scandinavian',          labelAr: 'إسكندنافي' },
  { value: 'minimalist',           labelEn: 'Minimalist',            labelAr: 'مينيمالست' },
  { value: 'modern',               labelEn: 'Modern',                labelAr: 'مودرن' },
  { value: 'contemporary',         labelEn: 'Contemporary',          labelAr: 'كونتمبراري' },
  { value: 'industrial',           labelEn: 'Industrial',            labelAr: 'إندستريال' },
  { value: 'loft',                 labelEn: 'Loft',                  labelAr: 'لوفت' },
  { value: 'bohemian',             labelEn: 'Bohemian (Boho)',       labelAr: 'بوهيمي' },
  { value: 'coastal',              labelEn: 'Coastal',               labelAr: 'ساحلي' },
  { value: 'tropical',             labelEn: 'Tropical',              labelAr: 'استوائي' },
  { value: 'rustic',               labelEn: 'Rustic',                labelAr: 'ريفي' },
  { value: 'farmhouse',            labelEn: 'Farmhouse',             labelAr: 'فارم هاوس' },
  { value: 'art-deco',             labelEn: 'Art Deco',              labelAr: 'آرت ديكو' },
  { value: 'hollywood-glam',       labelEn: 'Hollywood Glam',        labelAr: 'هوليوود جلام' },
  { value: 'maximalist',           labelEn: 'Maximalist',            labelAr: 'ماكسيمالست' },
  { value: 'mediterranean',        labelEn: 'Mediterranean',         labelAr: 'بحر أبيض متوسطي' },
  { value: 'moroccan',             labelEn: 'Moroccan',              labelAr: 'مغربي' },
  { value: 'arabic-islamic',       labelEn: 'Arabic / Islamic',      labelAr: 'عربي / إسلامي' },
  { value: 'japanese-traditional', labelEn: 'Japanese Traditional',  labelAr: 'ياباني تقليدي' },
  { value: 'transitional',         labelEn: 'Transitional',          labelAr: 'ترانزيشنال' },
  { value: 'modern-classic',       labelEn: 'Modern Classic',        labelAr: 'مودرن كلاسيك' },
  { value: 'eclectic',             labelEn: 'Eclectic',              labelAr: 'إكلكتيك' },
  { value: 'retro',                labelEn: 'Retro',                 labelAr: 'ريترو' },
];
